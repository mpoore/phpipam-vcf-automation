# Base image
FROM --platform=linux/amd64 photon:latest

ADD target/python /ipam/python

RUN tdnf install -y python3-pip.noarch python3-devel gcc glibc-devel binutils linux-api-headers shadow make rust && \
